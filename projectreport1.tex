...
{\Large \textbf{\chapter{Introduction}}}
\\
...
{\Large \textbf{\chapter{Emulator Structure}}}
\\
...
Difficulties arose in implementing the pipeline correctly as registers were failing to load and the PC counter was wildly inaccurate. We eventually fixed this by creating explicit functions for decode and execute, ensuring the two processes were occuring in separate cycles.

We also made several functions to aid our understanding of what was happening during the processes e.g. basic printing functions for instructions and registers, which were necessary for the test cases anyway. On top of that, a few functions created early on \\
...
{\Large \textbf{\chapter{Communication}}}
\\
...
{\Large \textbf{\chapter{Looking Ahead}}}
\\
